    ...
    public class ReadLibrary : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (mainDirectory != null)
            {
                ...
                MorphoEnvimetLibrary.IO.Read metafile = new MorphoEnvimetLibrary.IO.Read() { Metaname = dbFile };

                // destination file
                string destinationFolder = MorphoEnvimetLibrary.IO.Workspace.CreateDestinationFolder();
