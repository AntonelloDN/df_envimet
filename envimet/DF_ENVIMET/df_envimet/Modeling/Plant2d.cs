...
namespace df_envimet.Modeling
{
    public class Plant2d : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (_plantId_ == null)
                _plantId_ = MorphoEnvimetLibrary.Geometry.Material.CommonPlant2dMaterial;
            // actions
            ...
            MorphoEnvimetLibrary.Geometry.Plant2d trees = new MorphoEnvimetLibrary.Geometry.Plant2d(_plant2D, material);
