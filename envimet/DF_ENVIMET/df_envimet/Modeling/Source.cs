...
namespace df_envimet.Modeling
{
    public class Source : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            // declaration
            Mesh _source = null;
            string _sourceId_ = MorphoEnvimetLibrary.Geometry.Material.CommonSourceMaterial;
            ...
            MorphoEnvimetLibrary.Geometry.Source sources = new MorphoEnvimetLibrary.Geometry.Source(_source, material);
