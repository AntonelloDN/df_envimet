...
namespace DragonflyEnvimet
{
    public class SoilSettings : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            // actions
            envimetSimulationFile.SoilTemp lbcSettings = new envimetSimulationFile.SoilTemp()
            {
                TempUpperlayer = tul
                ,TempMiddlelayer = tml
                ,TempDeeplayer = tdl
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return DragonflyEnvimet.Properties.Resources.envimetSoilSettingsIcon;
            }
        }
        ...
        {
            get { return new Guid("c0d62995-8213-4304-a58a-7b44dce22d08"); }
        }
    }
}